...
function preload() {
    ...
    game.load.tilemap('level1', '/tilemaps/maps/pacman-map.json',null, Phaser.Tilemap.TILED_JSON);
    game.load.spritesheet('tiles', 'assets/tilemaps/tiles/pacman-tiles.png', 16, 16);
